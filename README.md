...
### Practical tips
- Avoid styling directly on element selectors such as H1, H2, H3 in combination with classes. This avoids a mess of cascading styles not knowing what the result could be. For example: `.class-name h1` should not be used. Instead use for example the BEM notation `.class-name__title`.
